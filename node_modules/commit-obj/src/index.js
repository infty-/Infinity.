...
var ObjCommiter = module.exports = Function.create(function (emitter, victim) {
	...
	prototype: Member(Object.create(Object.prototype, {
		...
		var editedEnts = editedPairs.entrySet;
		...
		var pairs = editedPairs.concat(); // TODO compute new this.pairs (also think of died and new properties)
	    }),
